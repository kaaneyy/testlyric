...
- Whole-song review context: general tasks such as structure analysis, full-song review, initial audit, and chorus generation send the full song text plus compressed song memory to the AI instead of only the selected line.
- Initial song tests: run an audit after pasting/uploading lyrics to find missing sections, empty spots, filler, cliches, obvious mistakes, and one-click review/fix actions.
